            ...
            if (json.medIng.length != 0) {
                ...
                for (var i = 0; i < medInge['nombre'].length; i++) {
                    ...
                    if (i == medInge['nombre'].length - 1) {
                        $('#controlesIng').append(' <li class="list-group-item" id=0 ><input placeholder="Digite Otro" style="color: black; background-color: #c2c2c7;"></li>');
            ...
            if (json.medAdmin.length != 0) {
                ...
                for (var i = 0; i < medAdmini['nombre'].length; i++) {
                    ...
                    if (i == medAdmini['nombre'].length - 1) {
                        $('#controlesAdmin').append(' <li class="list-group-item" id=0 ><input placeholder="Digite Otro" style="color: black; background-color: #c2c2c7;"></li>');
            ...
            if (json.medEpp.length != 0) {
                ...
                for (var i = 0; i < medEpps['nombre'].length; i++) {
                    ...
                    if (i == medEpps['nombre'].length - 1) {
                        $('#controlesEpp').append(' <li class="list-group-item" id=0 ><input placeholder="Digite Otro" style="color: black; background-color: #c2c2c7;"></li>');
...
function addItemMatriz() {
    ...
    $.ajax({
        url: url + '/guardarMatriz',
        method: 'post',
        data: { url },
        success: function (json) {
            $('#matrizCreada').val(json.creadaMatriz);
            $('#idMatriz').val(json.idEmpMatriz);
